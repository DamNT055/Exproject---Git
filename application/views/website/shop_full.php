              ...
              <div class="offcanvas-body ps-lg-2 pt-lg-0">
                <div class="mb-8">
                  ...
                  <ul class="nav nav-category" id="categoryCollapseMenu">
                    <?php foreach ($category as $row) { ?>
                      <li class="nav-item border-bottom w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#categoryFlush<?= $row->id ?>" aria-expanded="false" aria-controls="categoryFlush<?= $row->id ?>"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#" class="nav-link"><?= $row->name ?> <i class="feather-icon icon-chevron-right"></i></a>
                        <!-- accordion collapse -->
                        <div id="categoryFlush<?= $row->id ?>" class="accordion-collapse collapse" data-bs-parent="#categoryCollapseMenu" style="">
                          <div>
                            ...
                            <ul class="nav flex-column ms-3">
                              <!-- nav item -->
                              <li class="nav-item"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="nav-link">Milk 1</a></li>
                              <!-- nav item -->
                              <li class="nav-item"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="nav-link">Milk 2</a></li>
                            </ul>
                          </div>
                        </div>
                      </li>
            ...
            <div class="row g-4 row-cols-xl-4 row-cols-lg-3 row-cols-2 row-cols-md-2 mt-2">
                  ...
                  <div class="card-body">
                    ...
                    <div class="text-center position-relative ">
                      ...
                      <a href="https://freshcart.codescandy.com/pages/shop-single.html">
                        <!-- img --><img src="./FreshCart - eCommerce HTML Template_files/product-img-1.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid">
                      </a>
                      <!-- action btn -->
                      <div class="card-product-action">
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                        ...
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                      </div>
                    </div>
                    <!-- heading -->
                    <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="text-decoration-none text-muted"><small>Snack &amp;
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                      ...
                      <!-- btn -->
                      <div><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn btn-primary btn-sm">
                ...
                <div class="card card-product">
                  <div class="card-body">
                    ...
                    <div class="text-center position-relative">
                      ...
                      <a href="https://freshcart.codescandy.com/pages/shop-single.html">
                        <!-- img --><img src="./FreshCart - eCommerce HTML Template_files/product-img-2.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid">
                      </a>
                      <!-- action btn -->
                      <div class="card-product-action">
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                      </div>
                    </div>
                    <!-- heading -->
                    <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="text-decoration-none text-muted"><small>Bakery &amp;
                          Biscuits</small></a></div>
                    <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">NutriChoice Digestive </a>
                    </h2>
              ...
              <div class="col">
                ...
                <div class="card card-product">
                  <div class="card-body">
                    <!-- badge -->
                    <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="./FreshCart - eCommerce HTML Template_files/product-img-3.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                      <!-- action btn -->
                      <div class="card-product-action">
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    ...
                    <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="text-decoration-none text-muted"><small>Bakery &amp;
                          Biscuits</small></a></div>
                    <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Cadbury 5 Star Chocolate</a>
                    </h2>
                    <div class="text-warning">
                      <!-- rating -->
                      <small> <i class="bi bi-star-fill"></i>
                ...
                <div class="card card-product">
                  <div class="card-body">
                    ...
                    <div class="text-center position-relative">
                      ...
                      <a href="https://freshcart.codescandy.com/pages/shop-single.html">
                        <!-- img --><img src="./FreshCart - eCommerce HTML Template_files/product-img-4.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid">
                      </a>
                      <!-- action btn -->
                      <div class="card-product-action">
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
              ...
              <div class="col">
                ...
                <div class="card card-product">
                  <div class="card-body">
                    <!-- badge -->
                    <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="./FreshCart - eCommerce HTML Template_files/product-img-5.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                      <!-- action btn -->
                      <div class="card-product-action">
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    ...
                    <!-- heading -->
                    <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="text-decoration-none text-muted"><small>Instant
                          Food</small></a></div>
                    <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Salted Instant Popcorn </a>
                    </h2>
                    <div class="text-warning">
                      <!-- rating -->
                      <small> <i class="bi bi-star-fill"></i>
                ...
                <div class="card card-product">
                  <div class="card-body">
                    ...
                    <div class="text-center position-relative ">
                      ...
                      <a href="https://freshcart.codescandy.com/pages/shop-single.html">
                        <!-- img --><img src="./FreshCart - eCommerce HTML Template_files/product-img-6.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid">
                      </a>
                      <!-- action btn -->
                      <div class="card-product-action">
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    ...
                    <!-- heading -->
                    <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="text-decoration-none text-muted"><small>Dairy, Bread
                          &amp;
                          Eggs</small></a></div>
                    <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Blueberry Greek Yogurt</a>
                    </h2>
                    <div>
                      <!-- rating -->
                      <small class="text-warning"> <i class="bi bi-star-fill"></i>
              ...
              <div class="col">
                ...
                <div class="card card-product">
                  <div class="card-body">
                    <!-- badge -->
                    <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="./FreshCart - eCommerce HTML Template_files/product-img-7.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                      <!-- action btn -->
                      <div class="card-product-action">
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    ...
                    <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="text-decoration-none text-muted"><small>Dairy, Bread
                          &amp;
                          Eggs</small></a></div>
                    <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Britannia Cheese Slices</a>
                    </h2>
                    <div class="text-warning">
                      <!-- rating -->
                      <small> <i class="bi bi-star-fill"></i>
              ...
              <div class="col">
                ...
                <div class="card card-product">
                  <div class="card-body">
                    <!-- badge -->
                    <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="./FreshCart - eCommerce HTML Template_files/product-img-8.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                      <!-- action btn -->
                      <div class="card-product-action">
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    ...
                    <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="text-decoration-none text-muted"><small>Instant
                          Food</small></a></div>
                    <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Kellogg's Original Cereals</a>
                    </h2>
                    <div class="text-warning">
                      <!-- rating -->
                      <small> <i class="bi bi-star-fill"></i>
              ...
              <div class="col">
                ...
                <div class="card card-product">
                  <div class="card-body">
                    <!-- badge -->
                    <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="./FreshCart - eCommerce HTML Template_files/product-img-9.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                      <!-- action btn -->
                      <div class="card-product-action">
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                        <a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    ...
                    <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="text-decoration-none text-muted"><small>Snack &amp;
                          Munchies</small></a></div>
                    <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Slurrp Millet Chocolate </a>
                    </h2>
                    <div class="text-warning">
                      <!-- rating -->
                      <small> <i class="bi bi-star-fill"></i>
              ...
              <div class="col">
                ...
                <div class="card card-product">
                  <div class="card-body">
                    <!-- badge -->
                    <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="./FreshCart - eCommerce HTML Template_files/product-img-10.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                      <!-- action btn -->
                      <div class="card-product-action">
                    ...
                    <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-grid.html#!" class="text-decoration-none text-muted"><small>Dairy, Bread
                          &amp;
                          Eggs</small></a></div>
                    <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Amul Butter - 500 g</a></h2>
                    <div class="text-warning">
                      <!-- rating -->
                      <small> <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-fill"></i>
                ...
                <nav>
                  <ul class="pagination">
                    <li class="page-item disabled">
                      <a class="page-link  mx-1 " href="https://freshcart.codescandy.com/pages/shop-grid.html#" aria-label="Previous">
                        <i class="feather-icon icon-chevron-left"></i>
                      </a>
                    </li>
                    <li class="page-item "><a class="page-link  mx-1 active" href="https://freshcart.codescandy.com/pages/shop-grid.html#">1</a></li>
                    <li class="page-item"><a class="page-link mx-1 text-body" href="https://freshcart.codescandy.com/pages/shop-grid.html#">2</a></li>

                    <li class="page-item"><a class="page-link mx-1 text-body" href="https://freshcart.codescandy.com/pages/shop-grid.html#">...</a></li>
                    <li class="page-item"><a class="page-link mx-1 text-body" href="https://freshcart.codescandy.com/pages/shop-grid.html#">12</a></li>
                    <li class="page-item">
                      <a class="page-link mx-1 text-body" href="https://freshcart.codescandy.com/pages/shop-grid.html#" aria-label="Next">
