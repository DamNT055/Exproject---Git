          ...
          <div class="col-12">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="https://freshcart.codescandy.com/pages/shop-single.html#">Home</a>
                </li>
                <li class="breadcrumb-item"><a href="https://freshcart.codescandy.com/pages/shop-single.html#">Bakery
                    Biscuits</a></li>
        ...
        <div class="row">
                ...
                <div class="tns-inner" id="product-iw">
                  <div class="product  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" id="product" style="transition-duration: 0s; transform: translate3d(-16.6667%, 0px, 0px);">
                    <div class="tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
                      <div class="zoom" onmousemove="zoom(event)" style="background-image: url(<?=base_url('assets/images/product/product-single-img-4.jpg')?>)">
                        <!-- img -->
                        <img src="<?=base_url('assets/images/product/product-single-img-4.jpg')?>" alt="">
                      </div>
                    </div>
                    <div class="zoom tns-item tns-slide-active" onmousemove="zoom(event)" style="background-image: url(<?=base_url('assets/images/product/product-single-img-1.jpg')?>); background-position: 98.3516% 1.46341%;" id="product-item0">
                      <!-- img -->
                      <!-- img --><img src="<?=base_url('assets/images/product/product-single-img-1.jpg')?>" alt="">
                    </div>
                    <div class="tns-item" id="product-item1" aria-hidden="true" tabindex="-1">
                      <div class="zoom" onmousemove="zoom(event)" style="background-image: url(<?=base_url('assets/images/product/product-single-img-2.jpg')?>)">
                        <!-- img -->
                    ...
                    <div class="tns-item" id="product-item2" aria-hidden="true" tabindex="-1">
                      <div class="zoom" onmousemove="zoom(event)" style="background-image: url(<?=base_url('assets/images/product/product-single-img-3.jpg')?>)">
                        <!-- img -->
                    ...
                    <div class="zoom tns-item tns-slide-cloned" onmousemove="zoom(event)" style="background-image: url(<?=base_url('assets/images/product/product-single-img-1.jpg')?>)" aria-hidden="true" tabindex="-1">
                      <!-- img -->
                      <!-- img --><img src="<?=base_url('assets/images/product/product-single-img-1.jpg')?>" alt="">
                    </div>
                  </div>
          ...
          <div class="col-md-6">
            <div class="ps-lg-10 mt-6 mt-md-0">
              <!-- content -->
              <a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="mb-4 d-block">Bakery
                Biscuits</a>
              <!-- heading -->
              ...
              <div class="mb-4">
                ...
                <!-- rating --> <small class="text-warning"> <i class="bi bi-star-fill"></i>
                  ...
                  <i class="bi bi-star-fill"></i>
                  <i class="bi bi-star-fill"></i>
                  <i class="bi bi-star-half"></i></small><a href="https://freshcart.codescandy.com/pages/shop-single.html#" class="ms-2">(30 reviews)</a>
              </div>
              <div class="fs-4">
              ...
              <div class="mt-3 row justify-content-start g-2 align-items-center">
                ...
                <div class="col-md-4 col-4">
                  <!-- btn -->
                  <a class="btn btn-light " href="https://freshcart.codescandy.com/pages/shop-single.html#" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare"><i class="bi bi-arrow-left-right"></i></a>
                  <a class="btn btn-light " href="https://freshcart.codescandy.com/pages/shop-wishlist.html" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist"><i class="feather-icon icon-heart"></i></a>
                </div>
              </div>
              <!-- hr -->
              <hr class="my-6">
              ...
              <div class="mt-8">
                <!-- dropdown -->
                <div class="dropdown">
                  <a class="btn btn-outline-secondary dropdown-toggle" href="https://freshcart.codescandy.com/pages/shop-single.html#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Share
                  </a>

                  <ul class="dropdown-menu" style="">
                    <li><a class="dropdown-item" href="https://freshcart.codescandy.com/pages/shop-single.html#"><i class="bi bi-facebook me-2"></i>Facebook</a></li>
                    <li><a class="dropdown-item" href="https://freshcart.codescandy.com/pages/shop-single.html#"><i class="bi bi-twitter me-2"></i>Twitter</a></li>
                    <li><a class="dropdown-item" href="https://freshcart.codescandy.com/pages/shop-single.html#"><i class="bi bi-instagram me-2"></i>Instagram</a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <ul class="nav nav-pills nav-lb-tab" id="myTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <!-- btn --> <button class="nav-link" id="product-tab" data-bs-toggle="tab" data-bs-target="#product-tab-pane" type="button" role="tab" aria-controls="product-tab-pane" aria-selected="false" tabindex="-1">Product Details</button>
              </li>
              <!-- nav item -->
              <li class="nav-item" role="presentation">
                <!-- btn --> <button class="nav-link active" id="details-tab" data-bs-toggle="tab" data-bs-target="#details-tab-pane" type="button" role="tab" aria-controls="details-tab-pane" aria-selected="true">Information</button>
              </li>
              <!-- nav item -->
              <li class="nav-item" role="presentation">
                <!-- btn --> <button class="nav-link" id="reviews-tab" data-bs-toggle="tab" data-bs-target="#reviews-tab-pane" type="button" role="tab" aria-controls="reviews-tab-pane" aria-selected="false" tabindex="-1">Reviews</button>
              </li>
              <!-- nav item -->
              <li class="nav-item" role="presentation">
                <!-- btn --> <button class="nav-link" id="sellerInfo-tab" data-bs-toggle="tab" data-bs-target="#sellerInfo-tab-pane" type="button" role="tab" aria-controls="sellerInfo-tab-pane" aria-selected="false" disabled="" tabindex="-1">Seller
                  Info</button>
              </li>
            </ul>
            <!-- tab content -->
                    ...
                    <div class="col-md-4">
                      <div class="me-lg-12 mb-6 mb-md-0">
                        <div class="mb-5">
                          ...
                          <span>
                            <!-- rating --> <small class="text-warning"> <i class="bi bi-star-fill"></i>
                              ...
                              <i class="bi bi-star-fill"></i>
                              <i class="bi bi-star-fill"></i>
                              <i class="bi bi-star-half"></i></small><span class="ms-3">4.1 out of 5</span><small class="ms-3">11,130 global ratings</small>
                          </span>
                        </div>
                        <div class="mb-8">
                          <!-- progress -->
                        ...
                        <div class="d-grid">
                          ...
                          <a href="https://freshcart.codescandy.com/pages/shop-single.html#" class="btn btn-outline-gray-400 mt-4 text-muted">Write the Review</a>
                        </div>
                    ...
                    <div class="col-md-8">
                      <div class="mb-10">
                        ...
                        <div class="d-flex border-bottom pb-6 mb-6">
                          <!-- img -->
                          <!-- img --><img src="<?=base_url('assets/images/avatar/avatar-10.jpg')?>" alt="" class="rounded-circle avatar-lg">
                          <div class="ms-5">
                            <h6 class="mb-1">
                              Shankar Subbaraman
                            ...
                            <div>
                              <div class="border icon-shape icon-lg border-2 ">
                                <!-- img --><img src="<?= base_url('assets/images/product/product-img-1.jpg') ?>" alt="" class="img-fluid ">
                              </div>
                              <div class="border icon-shape icon-lg border-2 ms-1 ">
                                <!-- img --><img src="<?= base_url('assets/images/product/product-img-2.jpg') ?>" alt="" class="img-fluid ">
                              </div>
                              <div class="border icon-shape icon-lg border-2 ms-1 ">
                                <!-- img --><img src="<?=base_url('assets/images/product/product-img-3.jpg')?>" alt="" class="img-fluid ">
                              </div>

                            </div>
                            <!-- icon -->
                            <div class="d-flex justify-content-end mt-4">
                              <a href="https://freshcart.codescandy.com/pages/shop-single.html#" class="text-muted"><i class="feather-icon icon-thumbs-up me-1"></i>Helpful</a>
                              <a href="https://freshcart.codescandy.com/pages/shop-single.html#" class="text-muted ms-4"><i class="feather-icon icon-flag me-2"></i>Report
                                abuse</a>
                            </div>
                          </div>
                        </div>
                        <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                          <!-- img --><img src="<?=base_url('assets/images/avatar/avatar-12.jpg')?>" alt="" class="rounded-circle avatar-lg">
                          <div class="ms-5">
                            <h6 class="mb-1">
                              Robert Thomas
                        ...
                        <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                          <!-- img --><img src="<?=base_url('assets/images/avatar/avatar-9.jpg')?>" alt="" class="rounded-circle avatar-lg">
                          <div class="ms-5">
                            <h6 class="mb-1">
                              Barbara Tay
                        ...
                        <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                          <!-- img --><img src="<?=base_url('assets/images/avatar/avatar-8.jpg')?>" alt="" class="rounded-circle avatar-lg">
                        ...
                        <div>
                          <a href="https://freshcart.codescandy.com/pages/shop-single.html#" class="btn btn-outline-gray-400 text-muted">Read More Reviews</a>
                        </div>
                      </div>
                      <div>
                        <!-- rating -->
                        ...
                        <div class="border-bottom py-4 mb-4">
                          ...
                          <div id="rater" class="star-rating" style="width: 100px; height: 20px; background-size: 20px;" title="5/5">
                            <div class="star-value" style="background-size: 20px; width: 0%;"></div>
                          </div>
                        </div>
                        <div class="border-bottom py-4 mb-4">
                          ...
                          <div class="my-5">
                            <h5>Flavor</h5>
                            <div id="rate-2" class="star-rating" style="width: 100px; height: 20px; background-size: 20px;">
                              <div class="star-value" style="background-size: 20px; width: 0px;"></div>
                            </div>
                          </div>
                          <div class="my-5">
                            <h5>Value for money</h5>
                            <div id="rate-3" class="star-rating" style="width: 100px; height: 20px; background-size: 20px;">
                              <div class="star-value" style="background-size: 20px; width: 0px;"></div>
                            </div>
                          </div>
                          <div class="my-5">
                            <h5>Scent</h5>
                            <div id="rate-4" class="star-rating" style="width: 100px; height: 20px; background-size: 20px;" title="3/5">
                              <div class="star-value" style="background-size: 20px; width: 0%;"></div>
                            </div>
                          </div>
                        ...
                        <div class="border-bottom py-4 mb-4">
                          ...
                          <!-- form -->
                          <form action="https://freshcart.codescandy.com/pages/shop-single.html#" class="dropzone profile-dropzone dz-clickable">
                        ...
                        <div class="d-flex justify-content-end">
                          <a href="https://freshcart.codescandy.com/pages/shop-single.html#" class="btn btn-primary">Submit Review</a>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="row g-4 row-cols-lg-5 row-cols-2 row-cols-md-2 mt-2">
            ...
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-center position-relative ">
                  ...
                  <a href="https://freshcart.codescandy.com/pages/shop-single.html#!">
                    <!-- img --><img src="<?= base_url('assets/images/product/product-img-1.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid">
                  </a>
                  <!-- action btn -->
                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/pages/shop-wishlist.html" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    <a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                  </div>
                </div>
                <!-- heading -->
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="text-decoration-none text-muted"><small>Snack &amp;
                      Munchies</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="text-inherit text-decoration-none">Haldiram's Sev Bhujia</a></h2>
                <div>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                  ...
                  <!-- btn -->
                  <div><a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="btn btn-primary btn-sm">
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                <!-- badge -->
                <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html#!"><img src="<?= base_url('assets/images/product/product-img-2.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                  <!-- action btn -->
                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/pages/shop-wishlist.html" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                ...
                <!-- heading -->
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="text-decoration-none text-muted"><small>Bakery &amp;
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="text-decoration-none text-muted"><small>Bakery &amp;
                      Biscuits</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="text-inherit text-decoration-none">Cadbury 5 Star Chocolate</a></h2>
                <div class="text-warning">
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="text-decoration-none text-muted"><small>Snack &amp;
                      Munchies</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="text-inherit text-decoration-none">Onion Flavour Potato</a></h2>
                <div class="text-warning">
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="text-decoration-none text-muted"><small>Snack &amp;
                      Munchies</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html#!" class="text-inherit text-decoration-none">Slurrp Millet Chocolate </a></h2>
                <div class="text-warning">
            ...
            <div class="col-lg-6">
              ...
              <div class="tns-outer" id="productModal-ow">
                ...
                " id="productModal-item0">
                    ...
                    background-image: url(<?=base_url('assets/images/product/product-single-img-2')?>);
                  ">
                          <!-- img -->
                          <img src="<?= base_url('assets/images/product/product-single-img-2.jpg') ?>" alt="">
                        </div>
                      ...
                      <div class="tns-item" id="productModal-item2" aria-hidden="true" tabindex="-1">
                        <div class="zoom" onmousemove="zoom(event)" style="
                    background-image: url(<?=base_url('assets/images/product/product-single-img-3.jpg')?>);
                  ">
                          <!-- img -->
                          <img src="<?= base_url('assets/images/product/product-single-img-3.jpg') ?>" alt="">
                        </div>
                      ...
                      <div class="tns-item" id="productModal-item3" aria-hidden="true" tabindex="-1">
                        <div class="zoom" onmousemove="zoom(event)" style="
                    background-image: url(<?=base_url('assets/images/product/product-single-img-4.jpg')?>);
                  ">
                          <!-- img -->
                          <img src="<?= base_url('assets/images/product/product-single-img-4.jpg') ?>" alt="">
                        </div>
