...
<head>
  ...
  <title>FreshCart - eCommerce</title>
        ...
        <div class="row w-100 align-items-center gx-lg-2 gx-0">
          <div class="col-xxl-2 col-lg-3">
            <a class="navbar-brand d-none d-lg-block" href="<?= base_url() ?>">
              <img src="<?= base_url('assets/images/freshcart-logo.svg') ?>" alt="eCommerce HTML Template">
          ...
          <div class="col-md-2 col-xxl-1 text-end d-none d-lg-block">
            ...
            <div class="list-inline">
              <div class="list-inline-item">
                ...
                <a href="https://freshcart.codescandy.com/pages/shop-wishlist.html" class="text-muted position-relative">
      ...
      <div class="container px-0 px-md-3">
        <div class="dropdown me-3 d-none d-lg-block">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            <?php foreach ($category as $row) { ?>
              <li><a href="https://freshcart.codescandy.com/pages/shop-grid.html" class="dropdown-item d-flex justify-content-between mb-1 py-1">
                  <div>
                    <?=$row->icon?>
        ...
        <div class="offcanvas offcanvas-start p-4 p-lg-0" id="navbar-default">
          <div class="d-flex justify-content-between align-items-center mb-2 d-block d-lg-none">
            <a href="https://freshcart.codescandy.com/index.html"><img src="<?= base_url('assets/images/freshcart-logo.svg') ?>" alt="eCommerce HTML Template"></a>
    ...
    <div class="offcanvas-body">
      ...
      <div class="">
        ...
        <div class="alert alert-danger p-2" role="alert">
          You’ve got FREE delivery. Start <a href="https://freshcart.codescandy.com/index.html#!" class="alert-link">checkout now!</a>
        </div>
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item py-3 ps-0 border-top">
            ...
            <div class="row align-items-center">
              <div class="col-3 col-md-2">
                <!-- img --> <img src="<?= base_url('assets/images/product/product-img-1.jpg') ?>" alt="Ecommerce" class="img-fluid">
              </div>
              <div class="col-4 col-md-6 col-lg-5">
                ...
                <!-- text -->
                <div class="mt-2 small lh-1"> <a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-inherit"> <span class="me-1 align-text-bottom">
          ...
          <li class="list-group-item py-3 ps-0">
            ...
            <div class="row align-items-center">
              <div class="col-3 col-md-2">
                <!-- img --> <img src="<?= base_url('assets/images/product/product-img-2.jpg') ?>" alt="Ecommerce" class="img-fluid">
              </div>
              <div class="col-4 col-md-6 col-lg-5">
                <!-- title -->
                <a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit">
          ...
          <li class="list-group-item py-3 ps-0">
            ...
            <div class="row align-items-center">
              <div class="col-3 col-md-2">
                <!-- img --> <img src="<?= base_url('assets/images/product/product-img-3.jpg') ?>" alt="Ecommerce" class="img-fluid">
              </div>
              <div class="col-4 col-md-6 col-lg-5">
                <!-- title -->
                <a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit">
          ...
          <li class="list-group-item py-3 ps-0">
            ...
            <div class="row align-items-center">
              <div class="col-3 col-md-2">
                <!-- img --> <img src="<?= base_url('assets/images/product/product-img-4.jpg') ?>" alt="Ecommerce" class="img-fluid">
              </div>
              <div class="col-4 col-md-6 col-lg-5">
                <!-- title -->
                <a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit">
          ...
          <li class="list-group-item py-3 ps-0 border-bottom">
            ...
            <div class="row align-items-center">
              <div class="col-3 col-md-2">
                <!-- img --> <img src="<?= base_url('assets/images/product/product-img-5.jpg') ?>" alt="Ecommerce" class="img-fluid">
              </div>
              <div class="col-4 col-md-6 col-lg-5">
                <!-- title -->
                <a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit">
        ...
        <div class="d-flex justify-content-between mt-4">
          <a href="https://freshcart.codescandy.com/index.html#!" class="btn btn-primary">Continue Shopping</a>
          <a href="https://freshcart.codescandy.com/index.html#!" class="btn btn-dark">Update Cart</a>
        </div>
    ...
    <section class="mt-8">
      <div class="container">
        <div class="hero-slider ">
          <div style="background: url(<?= base_url('assets/images/slider/slide-1.jpg') ?>)no-repeat; background-size: cover; border-radius: .5rem; background-position: center;">
          ...
          <div class=" " style="background: url(<?= base_url('assets/images/slider/slider-2.jpg') ?>)no-repeat; background-size: cover; border-radius: .5rem; background-position: center;">
            <div class="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
      ...
      <div class="container">
        ...
        <div class="category-slider ">
          ...
          <div class="item"> <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
              <div class="card card-product mb-lg-4">
                <div class="card-body text-center py-8">
                  <img src="<?= base_url('assets/images/category/category-dairy-bread-eggs.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid">
          ...
          <div class="item"> <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
              <div class="card card-product mb-lg-4">
                <div class="card-body text-center py-8">
                  <img src="<?= base_url('assets/images/category/category-snack-munchies.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3">
          ...
          <div class="item"> <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
              <div class="card card-product mb-lg-4">
                <div class="card-body text-center py-8">
                  <img src="<?= base_url('assets/images/category/category-bakery-biscuits.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3">
          ...
          <div class="item"> <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
              <div class="card card-product mb-lg-4">
                <div class="card-body text-center py-8">
                  <img src="<?= base_url('assets/images/category/category-instant-food.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3">
          ...
          <div class="item"> <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
              <div class="card card-product mb-lg-4">
                <div class="card-body text-center py-8">
                  <img src="<?= base_url('assets/images/category/category-tea-coffee-drinks.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3">
          ...
          <div class="item"><a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
              <div class="card card-product mb-lg-4">
                <div class="card-body text-center py-8">
                  <img src="<?= base_url('assets/images/category/category-atta-rice-dal.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3">
          ...
          <div class="item"> <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
              <div class="card card-product mb-lg-4">
                <div class="card-body text-center py-8">
                  <img src="<?= base_url('assets/images/category/category-baby-care.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3">
          ...
          <div class="item"> <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
              <div class="card card-product mb-lg-4">
                <div class="card-body text-center py-8">
                  <img src="<?= base_url('assets/images/category/category-chicken-meat-fish.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3">
          ...
          <div class="item"> <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
              <div class="card card-product mb-lg-4">
                <div class="card-body text-center py-8">
                  <img src="<?= base_url('assets/images/category/category-cleaning-essentials.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3">
          ...
          <div class="item"> <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
              <div class="card card-product mb-lg-4">
                <div class="card-body text-center py-8">
                  <img src="<?= base_url('assets/images/category/category-pet-care.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3">
            ...
            <div>
              <div class="py-10 px-8 rounded" style="background:url(<?= base_url('assets/images/banner/grocery-banner.png') ?>)no-repeat; background-size: cover; background-position: center;">
                <div>
                  ...
                  <a href="https://freshcart.codescandy.com/index.html#!" class="btn btn-dark">Shop Now</a>
                </div>
              </div>
      ...
      <div class="container">
        ...
        <div class="row g-4 row-cols-lg-5 row-cols-2 row-cols-md-3">
            ...
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-center position-relative ">
                  ...
                  <a href="https://freshcart.codescandy.com/index.html#!"> <img src="<?= base_url('assets/images/product/product-img-1.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>

                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                  </div>

                </div>
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Snack &amp;
                      Munchies</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Haldiram's
                    Sev Bhujia</a></h2>
                <div>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                  ...
                  <div><a href="https://freshcart.codescandy.com/index.html#!" class="btn btn-primary btn-sm">
            ...
            <div class="card card-product">
              <div class="card-body">
                <div class="text-center position-relative">
                  ...
                  <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="<?= base_url('assets/images/product/product-img-2.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/shop-wishlist.html" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                  </div>

                </div>
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Bakery &amp;
                      Biscuits</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">NutriChoice Digestive </a></h2>
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="<?= base_url('assets/images/product/product-img-3.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/shop-wishlist.html" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                ...
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Bakery &amp;
                      Biscuits</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Cadbury 5
                    Star Chocolate</a></h2>
                <div class="text-warning">
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="<?= base_url('assets/images/product/product-img-4.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/shop-wishlist.html" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                ...
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Snack &amp;
                      Munchies</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Onion
                    Flavour Potato</a></h2>
                <div class="text-warning">
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="<?= base_url('assets/images/product/product-img-5.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/shop-wishlist.html" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                ...
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Instant
                      Food</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Salted
            ...
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-center position-relative ">
                  ...
                  <a href="https://freshcart.codescandy.com/index.html#!"> <img src="<?= base_url('assets/images/product/product-img-6.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                ...
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Dairy, Bread &amp;
                      Eggs</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Blueberry
                    Greek Yogurt</a></h2>
                <div>
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="<?= base_url('assets/images/product/product-img-7.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/shop-wishlist.html" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                ...
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Dairy, Bread &amp;
                      Eggs</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Britannia
                    Cheese Slices</a></h2>
                <div class="text-warning">
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="<?= base_url('assets/images/product/product-img-8.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/shop-wishlist.html" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                ...
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Instant
                      Food</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Kellogg's
                    Original Cereals</a>
                </h2>
                <div class="text-warning">
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="<?= base_url('assets/images/product/product-img-9.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/shop-wishlist.html" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                ...
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Snack &amp;
                      Munchies</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Slurrp
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                <div class="text-center position-relative"> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="<?= base_url('assets/images/product/product-img-10.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                  <div class="card-product-action">
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                    <a href="https://freshcart.codescandy.com/shop-wishlist.html" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                    <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                ...
                <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Dairy, Bread &amp;
                      Eggs</small></a></div>
                <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Amul
                    Butter - 500 g</a></h2>
                <div class="text-warning">
        ...
        <div class="table-responsive-xl pb-6">
          <div class="row row-cols-lg-4 row-cols-1 row-cols-md-2 g-4 flex-nowrap">
            <div class="col">
              <div class=" pt-8 px-6 px-xl-8 rounded" style="background:url(<?= base_url('assets/images/banner/banner-deal.jpg') ?>)no-repeat; background-size: cover; height: 470px;">
                <div>
                  ...
                  <a href="https://freshcart.codescandy.com/index.html#!" class="btn btn-primary">Shop Now <i class="feather-icon icon-arrow-right ms-1"></i></a>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center  position-relative "> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="<?= base_url('assets/images/product/product-img-11.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                  ...
                  <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Tea, Coffee &amp;
                        Drinks</small></a></div>
                  <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Roast
                      Ground Coffee</a></h2>
                  ...
                  <div class="d-grid mt-2"><a href="https://freshcart.codescandy.com/index.html#!" class="btn btn-primary ">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus">
                        <line x1="12" y1="5" x2="12" y2="19"></line>
                        <line x1="5" y1="12" x2="19" y2="12"></line>
                      </svg> Add to cart </a></div>
                  <div class="d-flex justify-content-start text-center mt-3">
                    <div class="deals-countdown w-100" data-countdown="2028/10/10 00:00:00"><span class="countdown-section"><span class="countdown-amount hover-up">1965</span><span class="countdown-period"> days </span></span><span class="countdown-section"><span class="countdown-amount hover-up">01</span><span class="countdown-period"> hours
                        </span></span><span class="countdown-section"><span class="countdown-amount hover-up">41</span><span class="countdown-period"> mins
                        </span></span><span class="countdown-section"><span class="countdown-amount hover-up">50</span><span class="countdown-period"> sec </span></span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col">
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center  position-relative "> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="<?= base_url('assets/images/product/product-img-12.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                    <div class="card-product-action">
                      <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                      <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                      <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                  ...
                  <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Fruits &amp;
                        Vegetables</small></a></div>
                  <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Crushed
                      Tomatoes</a></h2>
                  <div class="d-flex justify-content-between align-items-center mt-3">
                    <div><span class="text-dark">$13</span> <span class="text-decoration-line-through text-muted">$18</span>
                    </div>
                  ...
                  <div class="d-flex justify-content-start text-center mt-3 w-100">
                    <div class="deals-countdown w-100" data-countdown="2028/12/9 00:00:00"><span class="countdown-section"><span class="countdown-amount hover-up">2025</span><span class="countdown-period"> days </span></span><span class="countdown-section"><span class="countdown-amount hover-up">01</span><span class="countdown-period"> hours
                        </span></span><span class="countdown-section"><span class="countdown-amount hover-up">41</span><span class="countdown-period"> mins
                        </span></span><span class="countdown-section"><span class="countdown-amount hover-up">50</span><span class="countdown-period"> sec </span></span>
                    </div>
                  </div>
            ...
            <div class="col">
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center  position-relative "> <a href="https://freshcart.codescandy.com/pages/shop-single.html"><img src="<?= base_url('assets/images/product/product-img-13.jpg') ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                    <div class="card-product-action">
                      <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Quick View" data-bs-original-title="Quick View"></i></a>
                      <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist" data-bs-original-title="Wishlist"><i class="bi bi-heart"></i></a>
                      <a href="https://freshcart.codescandy.com/index.html#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare" data-bs-original-title="Compare"><i class="bi bi-arrow-left-right"></i></a>
                  ...
                  <div class="text-small mb-1"><a href="https://freshcart.codescandy.com/index.html#!" class="text-decoration-none text-muted"><small>Fruits &amp;
                        Vegetables</small></a></div>
                  <h2 class="fs-6"><a href="https://freshcart.codescandy.com/pages/shop-single.html" class="text-inherit text-decoration-none">Golden
                      Pineapple</a></h2>
                  <div class="d-flex justify-content-between align-items-center mt-3">
                    <div><span class="text-dark">$13</span> <span class="text-decoration-line-through text-muted">$18</span>
                    </div>
                  ...
                  <div class="d-flex justify-content-start text-center mt-3">
                    <div class="deals-countdown w-100" data-countdown="2028/11/11 00:00:00"><span class="countdown-section"><span class="countdown-amount hover-up">1997</span><span class="countdown-period"> days </span></span><span class="countdown-section"><span class="countdown-amount hover-up">01</span><span class="countdown-period"> hours
                        </span></span><span class="countdown-section"><span class="countdown-amount hover-up">41</span><span class="countdown-period"> mins
                        </span></span><span class="countdown-section"><span class="countdown-amount hover-up">50</span><span class="countdown-period"> sec </span></span>
                    </div>
                  </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="mb-8 mb-xl-0">
              ...
              <p>Not satisfied with a product? Return it at the doorstep &amp; get a refund within hours. No questions
                asked
                <a href="https://freshcart.codescandy.com/index.html#!">policy</a>.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="tns-outer" id="productModal-ow">
                ...
                " id="productModal-item0">
                  ...
                  ">
                          <!-- img -->
                          <img src="<?= base_url('assets/images/product/product-single-img-3.jpg') ?>" alt="">
                        </div>
                      </div>
                  ...
                  ">
                          <!-- img -->
                          <img src="<?= base_url('assets/images/product/product-single-img-4.jpg') ?>" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-lg-6">
              <div class="ps-lg-8 mt-6 mt-lg-0">
                <a href="https://freshcart.codescandy.com/index.html#!" class="mb-4 d-block">Bakery Biscuits</a>
                ...
                <div class="mb-4">
                  <small class="text-warning">
                    ...
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-half"></i></small><a href="https://freshcart.codescandy.com/index.html#" class="ms-2">(30 reviews)</a>
                </div>
                <div class="fs-4">
                ...
                <div class="mt-3 row justify-content-start g-2 align-items-center">
                  ...
                  <div class="col-md-4 col-5">
                    <!-- btn -->
                    <a class="btn btn-light" href="https://freshcart.codescandy.com/index.html#" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare"><i class="bi bi-arrow-left-right"></i></a>
                    <a class="btn btn-light" href="https://freshcart.codescandy.com/index.html#!" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist"><i class="feather-icon icon-heart"></i></a>
                  </div>
                </div>
                <hr class="my-6">
                <div>
          ...
          <div class="row">
            <div class="col-6">
              ...
              <ul class="nav flex-column">
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Vegetables &amp; Fruits</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">
                    Breakfast &amp; instant food</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">
                    Bakery &amp; Biscuits</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Atta,
                    rice &amp; dal</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Sauces &amp; spreads</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Organic &amp; gourmet</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link"> Baby
                    care</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Cleaning essentials</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Personal care</a></li>
              </ul>
            </div>
            <div class="col-6">
              <!-- list -->
              <ul class="nav flex-column">
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Dairy, bread &amp; eggs</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link"> Cold
                    drinks &amp; juices</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link"> Tea,
                    coffee &amp; drinks</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Masala, oil &amp; more</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Chicken, meat &amp; fish</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Paan
                    corner</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">
                    Pharma &amp; wellness</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Home
                    &amp; office</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Pet
                    care</a></li>
              </ul>
            </div>
          </div>
        ...
        <div class="col-12 col-md-12 col-lg-8">
          <div class="row g-4">
            <div class="col-6 col-sm-6 col-md-3">
              ...
              <!-- list -->
              <ul class="nav flex-column">
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Company</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">About</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#1" class="nav-link">Blog</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Help
                    Center</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Our
                    Value</a></li>
              </ul>
            </div>
            <div class="col-6 col-sm-6 col-md-3">
              ...
              <ul class="nav flex-column">
                <!-- list -->
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Payments</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Shipping</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Product Returns</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">FAQ</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/pages/shop-checkout.html" class="nav-link">Shop Checkout</a></li>
              </ul>
            </div>
            <div class="col-6 col-sm-6 col-md-3">
              ...
              <ul class="nav flex-column">
                <!-- list -->
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Shopper Opportunities</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Become a Shopper</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Earnings</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Ideas
                    &amp; Guides</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">New
                    Retailers</a></li>
              </ul>
            </div>
            <div class="col-6 col-sm-6 col-md-3">
              ...
              <ul class="nav flex-column">
                <!-- list -->
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Freshcart programs</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Gift
                    Cards</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Promos &amp; Coupons</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Freshcart Ads</a></li>
                <li class="nav-item mb-2"><a href="https://freshcart.codescandy.com/index.html#!" class="nav-link">Careers</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
            <ul class="list-inline mb-0">
              ...
              <li class="list-inline-item">
                <a href="https://freshcart.codescandy.com/index.html#!"><img src="<?= base_url('assets/images/amazonpay.svg') ?>" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="https://freshcart.codescandy.com/index.html#!"><img src="<?= base_url('assets/images/american-express.svg') ?>" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="https://freshcart.codescandy.com/index.html#!"><img src="<?= base_url('assets/images/mastercard.svg') ?>" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="https://freshcart.codescandy.com/index.html#!"><img src="<?= base_url('assets/images/paypal.svg') ?>" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="https://freshcart.codescandy.com/index.html#!"><img src="<?= base_url('assets/images/visa.svg') ?>" alt=""></a>
              </li>
            </ul>
          </div>
          <div class="col-lg-7 mt-4 mt-md-0">
            <ul class="list-inline mb-0 text-lg-end text-center">
              ...
              <li class="list-inline-item ms-4">
                <a href="https://freshcart.codescandy.com/index.html#!"> <img src="<?= base_url('assets/images/appstore-btn.svg') ?>" alt="" style="width: 140px;"></a>
              </li>
              <li class="list-inline-item">
                <a href="https://freshcart.codescandy.com/index.html#!"> <img src="<?= base_url('assets/images/googleplay-btn.svg') ?>" alt="" style="width: 140px;"></a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="col-md-6">
            <ul class="list-inline text-md-end mb-0 small mt-3 mt-md-0">
              ...
              <li class="list-inline-item me-1">
                <a href="https://freshcart.codescandy.com/index.html#!" class="btn btn-xs btn-social btn-icon"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z">
                    </path>
                  </svg></a>
              </li>
              <li class="list-inline-item me-1">
                <a href="https://freshcart.codescandy.com/index.html#!" class="btn btn-xs btn-social btn-icon"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                    <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z">
                    </path>
                  </svg></a>
              </li>
              <li class="list-inline-item">
                <a href="https://freshcart.codescandy.com/index.html#!" class="btn btn-xs btn-social btn-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
