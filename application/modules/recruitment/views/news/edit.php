...
<form action="<?php echo base_url('recruitment/news/update'); ?>" id="addPost" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-9">
				...
				<div class="tab-content">
                    ...
                    <div class="form-group" id="edit-slug-box">
                        ...
                        <div data-url="<?php echo base_url('recruitment/news/create_slug'); ?>" id="slug_id" data-id="<?php echo $detail->id; ?>"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="content" name="content" placeholder="Nội dung"><?php echo $detail->content; ?></textarea>
                    </div>
                    ...
                    <div class="tab-pane" id="tab_seo">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" row="4" id="seo_description" name="seo_description" placeholder="Mô tả"><?php echo $detail->seo_description; ?></textarea>
                        </div>
                    </div>
                    </div>
                    </div>
                    ...
                    <table class="table no-border no-padding">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <div class="form-group">
                                    <label>
                                    <?php echo form_checkbox('featured', '1', $detail->featured, array('class' => 'flat-red')); ?>
                                    </label>
                                </div>
                                </td>
                            </tr>
                ...
                <div class="box-body post-image" style="padding: 0px">
                    <div id="image-preview">
							<label for="image-upload" id="image-label">
								<p>Đổi</p>
                                <?php if($detail->image) : ?>
								    <img src="<?php echo base_url("assets/uploads/news/"); ?><?php echo $detail->image; ?>" id="img-review" class="thumbnail">
                                <?php else : ?>
            ...
            $('#content').on('froalaEditor.initialized', function (e, editor) {
                ...
                success: function (json) {
                    ...
                    if (json.error) {
                        ...
                        //setTimeout(function(){ window.location.href = '<?php echo base_url('announcements/detail/'); ?>'+json.message; }, 200);
                    }
                },
                error: function (json) {
                    console.log(json);
