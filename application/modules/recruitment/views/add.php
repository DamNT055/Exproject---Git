...
<form action="<?php echo base_url('recruitment/store'); ?>" id="addPost" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Tiêu đề" value="">
                            </div>
                        </div>
                        ...
                        <div class="form-group clearfix" id="edit-slug-box">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input readonly type="text" class="form-control" id="slug" name="slug" placeholder="Tên đường dẫn" value="">
                            ...
                            <div data-url="<?php echo base_url('recruitment/create_slug'); ?>" id="slug_id" data-id=""></div>
                        </div>

                            <div class="form-group clearfix">
                                <label class="control-label col-sm-4">Số lượng:</label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Số lượng" value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="work_time" name="work_time" placeholder="Thời gian làm việc" value="8h00 - 17h30 từ thứ 2 đến thứ 6, thứ 7 làm buổi sáng">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" id="type" name="type" placeholder="Full Time, Part Time" value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-8">
                                    <input  type="text" class="form-control datepicker"  id="start_date" name="start_date" placeholder="<?php echo date("d/m/Y"); ?>" value="" />
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-8">
                                    <input  type="text" class="form-control datepicker"  id="end_date" name="end_date" placeholder="<?php echo date("d/m/Y"); ?>" value="" />
                                </div>
                            </div>
...
<div class="form-group clearfix">
    ...
    <div class="col-sm-8">
        <input type="text" class="form-control" id="salary" name="salary" placeholder="Thu nhập" value="">
    </div>
</div>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_requirement">
                        <div class="form-group">
                            <label>Yêu cầu:</label>
                            <textarea class="form-control" id="requirement" name="requirement" placeholder="Yêu cầu"></textarea>
                        </div>
                    </div>
                    <div class="tab-pane" id="tab_benefit">
                        <div class="form-group">
                            <label>Quyền lợi:</label>
                            <textarea class="form-control" id="benefit" name="benefit" placeholder="Quyền lợi"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table no-border no-padding">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php echo form_dropdown('is_student', array('0' => 'Mặc định', '1' => 'Dành cho sinh viên'), null, array('class' => 'form-control')); ?>
                                </td>
                            </tr>
                            <tr>
                                <td style="white-space: nowrap; vertical-align: middle;">Bắt buộc điền Email</td>
                                <td>
                                <?php echo form_checkbox('mail_required', '1', null, array('class' => 'minimal')); ?>
                                </td>
                            </tr>
                            <tr>
                                <td style="white-space: nowrap; vertical-align: middle;">Bắt buộc gửi CV</td>
                                <td>
                                <?php echo form_checkbox('cv_required', '1', null, array('class' => 'minimal')); ?>
                                </td>
                            </tr>
                            <tr>
                                <td style="white-space: nowrap; vertical-align: middle;">Nổi bật</td>
                                <td>
                                <?php echo form_checkbox('featured', '1', null, array('class' => 'minimal')); ?>
                                </td>
                            </tr>
            ...
            <!-- <div class="box box-solid">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="seo_title" name="seo_title" placeholder="Tiêu đề Seo" value="">
                    </div>
                    <div class="form-group">
                        <label>Từ khóa:</label>
                        <input type="text" class="form-control" id="seo_keyword" name="seo_keyword" placeholder="Từ khóa" value="">
                    </div>
                    <div class="form-group">
                        <label>Mô tả SEO:</label>
                        <textarea class="form-control" row="4" id="seo_description" name="seo_description" placeholder="Mô tả SEO"></textarea>
                    </div>
                </div>
            </div> -->
...
<link rel="stylesheet" href="<?php echo base_url('assets/froalas/css/froala_editor.css'); ?>">
  ...
  $('input[type="checkbox"].minimal, input[type="radio"].minimal').iCheck({
    ...
    $('#position,#description,#benefit,#requirement').on('froalaEditor.initialized', function (e, editor) {
            ...
            $('#addPost').ajaxForm({
                ...
                success: function (json) {
                    ...
                    if (json.error) {
                        ...
                        setTimeout(function(){ window.location.href = "<?php echo base_url("recruitment/edit/"); ?>"+json.message; }, 1000);
            ...
            heightMin: 300,enter: $.FroalaEditor.ENTER_P, spellcheck: false,imageUploadURL: '<?php echo base_url('file/upload_image'); ?>',
