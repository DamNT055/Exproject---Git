...
<section class="content-header">
    <ol class="breadcrumb">
        ...
        <li class="active">Sửa album</li>
    </ol>

</section>
<form action="<?php echo base_url('recruitment/album/update'); ?>" id="addPost" method="post" enctype="multipart/form-data">
				...
				<div class="tab-content">
                    ...
                    <div class="form-group" id="edit-slug-box">
                        ...
                        <div class="input-group">
                            <input readonly type="text" class="form-control" id="slug" name="slug" placeholder="Tên đường dẫn" value="<?php echo $detail->slug; ?>">
                        ...
                        <div data-url="<?php echo base_url('recruitment/album/create_slug'); ?>" id="slug_id" data-id="<?php echo $detail->id; ?>"></div>
                    </div>

                    <div class="form-group">
                        <label>Mô tả:</label>
                        <textarea class="form-control" rows="8" id="description" name="description" placeholder="Mô tả"><?php echo $detail->description; ?></textarea>
                    </div>
                    ...
                    <div class="tab-pane" id="tab_seo">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="seo_title" name="seo_title" placeholder="Tiêu đề Seo" value="<?php echo $detail->seo_title; ?>">
                        </div>
                        <div class="form-group">
                            <label>Keywords:</label>
                            <input type="text" class="form-control" id="seo_keyword" name="seo_keyword" placeholder="" value="<?php echo $detail->seo_keyword; ?>">
                        </div>
                        <div class="form-group">
                            <label>SEO description:</label>
                            <textarea class="form-control" rows="8" id="seo_description" name="seo_description" placeholder="Mô tả"><?php echo $detail->seo_description; ?></textarea>
                        </div>
                    </div>
                    <div class="tab-pane" id="tab_images">
                        <?php include "images_edit.php";?>
                    </div>
                    </div>
                    </div>
        ...
        <table class="table no-border no-padding">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="order" class="form-control" value="<?php echo $detail->order; ?>">
                    </td>
                </tr>
...
<div class="box box-solid">
                ...
                <div class="box-body post-image" style="padding: 0px">
                    <div id="image-preview">
							<label for="image-upload" id="image-label">
								<p>Đổi</p>
                                <?php if($detail->image) : ?>
								    <img src="https://tuyendung.mia.vn/uploads/album/<?php echo $detail->image; ?>" id="img-review" class="thumbnail">
                                <?php else : ?>
        ...
        <div class="box box-solid"><button type="submit" id="submit" class="btn btn-primary btn-block" style="font-size:1.2em;">CẬP NHẬT</button></div>
